        ...
        <div class="p-12 bg-purple-400 rounded-lg bg-clip-padding backdrop-filter backdrop-blur-sm bg-opacity-10 border border-gray-100 ">
            <form action="" class="">
                ...
                <div class="border-b-2 mb-10 sm:w-96">
                    ...
                    <input type="text" class="w-full bg-transparent border-none text-white focus:ring-0  ">
                </div>
                ...
                <div class="border-b-2 mb-10">
                    ...
                    <input type="password" placeholder="" class="w-full bg-transparent border-none text-white focus:ring-0  ">
                </div>

                <button class="bg-violet-600 text-white w-full rounded-full py-2 shadow-lg hover:scale-95 duration-300 transition hover:bg-violet-700 font-bold">LOGIN</button>
            </form>
        </div>
    </div>
</body>
